...
exclude_patterns = ['docs', '_build', 'Thumbs.db', '.DS_Store', 'build/*']
...
breathe_projects = {
	"SchwurblerControllers": "../build/"
}
breathe_implementation_filename_extensions = [ '.c', '.cpp' ]

#breathe_projects_source = {
#    "auto" : ( "examples", [ "auto_function.h", "auto_class.h" ] )
#    }
...
breathe_default_project = "SchwurblerControllers"
